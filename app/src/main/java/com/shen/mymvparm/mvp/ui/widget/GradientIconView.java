 ...
 * Tab的icon设置
 *
 * 两张形状一样的图片，但是颜色风格不同，叠在一起，上层的图标设置自己的alpha透明度属性，下层的图标对应的把透明度设置成1-alpha，
 * 就可以做到两张图片渐变切换的效果
 */
public class GradientIconView extends FrameLayout {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.layout_tab_icon, this, true);
        mTopIconView = (ImageView) findViewById(R.id.iv_top);
        mBottomIconView = (ImageView) findViewById(R.id.iv_bottom);
    }
