package com.shen.mymvparm.mvp.ui.widget;
...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mType = a.getInt(R.styleable.CircleImageView_image_type,TYPE_CIRCLE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mType==TYPE_CIRCLE) {
            ...
            canvas.drawRoundRect(mDrawableRect, mImageRadiusWidth, mImageRadiusWidth, mBitmapPaint);
        }
    }
    ...
    private void setup() {
        ...
        mImageRadiusWidth = getResources().getDimensionPixelOffset(R.dimen.image_radius);
